...
from api.models.engines.google_translate_web import GoogleTranslateWeb
...
@patch('api.models.engines.google_translate_web.GoogleTranslateWeb.translate')
...
@patch('api.models.engines.google_translate_web.sleep')
...
@patch('api.models.engines.google_translate_web.logging')
