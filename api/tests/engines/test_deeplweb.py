...
from api.models.engines.deeplweb import DeepLWeb
...
class TestDeepLWeb:
    ...
    def test_translate_success(self, deepl_instance):
        with patch('api.models.engines.deeplweb.PyDeepLX') as mock_pydeeplx:
    ...
    @patch('api.models.engines.deeplweb.sleep')
    def test_translate_sleep(self, mock_sleep, deepl_instance):
        deepl_instance.interval = 5
        with patch('api.models.engines.deeplweb.PyDeepLX'):
    ...
    def test_translate_no_sleep_on_validate(self, deepl_instance):
        with patch('api.models.engines.deeplweb.sleep') as mock_sleep:
            with patch('api.models.engines.deeplweb.PyDeepLX'):
