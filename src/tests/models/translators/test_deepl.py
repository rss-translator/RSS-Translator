...
from src.models.translators.deepl import DeepL
...
# 测试validate方法
@patch('src.models.translators.deepl.deepl.Translator')
def test_validate_success(mock_translator, deepl_instance):
    ...
    assert deepl_instance.validate() == True
...
def test_validate_failure(mock_translator, deepl_instance):
    ...
    assert deepl_instance.validate() == False
