...
from src.models.translators.kagi import Kagi
...
@patch("src.models.translators.kagi.httpx.post")
def test_validate(mock_post, kagi_translator):
    ...
    assert kagi_translator.validate() == True
...
@patch("src.models.translators.kagi.logging")
@patch("src.models.translators.kagi.httpx.post")
