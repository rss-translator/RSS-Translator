...
class O_Feed(models.Model):
    ...
    content_type = models.ForeignKey(
        ContentType, on_delete=models.SET_NULL, null=True, related_name="o_translator"
    )
    object_id = models.PositiveIntegerField(null=True)
    o_translator = GenericForeignKey("content_type", "object_id")
