...
class O_Feed(models.Model):
    ...
    fetch_article = models.BooleanField(_("Fetch Original Article"), default=False, help_text=_("Fetch original article from the website."))
    ...
    category = SingleTagField(force_lowercase=True, blank=True, help_text=_("Enter a category string"))
