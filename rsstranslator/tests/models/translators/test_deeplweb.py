...
from rsstranslator.backend.models.translators.deeplweb import DeepLWeb
...
class TestDeepLWeb:
    ...
    def test_translate_success(self, deepl_instance):
        with patch('rsstranslator.backend.models.translators.deeplweb.PyDeepLX') as mock_pydeeplx:
    ...
    @patch('rsstranslator.backend.models.translators.deeplweb.sleep')
    def test_translate_sleep(self, mock_sleep, deepl_instance):
        deepl_instance.interval = 5
        with patch('rsstranslator.backend.models.translators.deeplweb.PyDeepLX'):
    ...
    def test_translate_no_sleep_on_validate(self, deepl_instance):
        with patch('rsstranslator.backend.models.translators.deeplweb.sleep') as mock_sleep:
            with patch('rsstranslator.backend.models.translators.deeplweb.PyDeepLX'):
