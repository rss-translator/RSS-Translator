...
from rsstranslator.backend.models.translators.google_translate_web import GoogleTranslateWeb
...
@patch('rsstranslator.backend.models.translators.google_translate_web.GoogleTranslateWeb.translate')
def test_validate(mock_translate, google_translate_web):
    mock_translate.return_value = {"text": "你好", "characters": 2}
    assert google_translate_web.validate() is True

    mock_translate.return_value = {"text": "", "characters": 2}
    assert google_translate_web.validate() is False

@patch('rsstranslator.backend.models.translators.google_translate_web.sleep')
...
@patch('rsstranslator.backend.models.translators.google_translate_web.logging')
