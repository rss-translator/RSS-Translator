...
from rsstranslator.backend.models.translators.openl import Openl
...
@patch("rsstranslator.backend.models.translators.openl.httpx.post")
...
@patch("rsstranslator.backend.models.translators.openl.logging")
@patch("rsstranslator.backend.models.translators.openl.httpx.post")
