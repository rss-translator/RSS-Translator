...
from rsstranslator.backend.models.translators.microsoft_translate import MicrosoftTranslator
...
@patch("rsstranslator.backend.models.translators.microsoft_translate.MicrosoftTranslator.translate")
def test_validate(mock_translate, microsoft_translator):
    mock_translate.return_value = {"text": "你好", "characters": 2}
    assert microsoft_translator.validate() is True

    mock_translate.return_value = {"text": "", "characters": 2}
    assert microsoft_translator.validate() is False

@patch("rsstranslator.backend.models.translators.microsoft_translate.httpx.Client")
...
@patch("rsstranslator.backend.models.translators.microsoft_translate.logging")
@patch("rsstranslator.backend.models.translators.microsoft_translate.httpx.Client")
