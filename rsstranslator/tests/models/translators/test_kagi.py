...
from rsstranslator.backend.models.translators.kagi import Kagi
...
@patch("rsstranslator.backend.models.translators.kagi.httpx.post")
...
@patch("rsstranslator.backend.models.translators.kagi.logging")
@patch("rsstranslator.backend.models.translators.kagi.httpx.post")
