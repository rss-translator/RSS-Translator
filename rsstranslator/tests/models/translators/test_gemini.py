...
from rsstranslator.backend.models.translators.gemini import Gemini
...
class TestGemini:
    ...
    @patch("rsstranslator.backend.models.translators.gemini.genai.GenerativeModel")
    ...
    @patch("rsstranslator.backend.models.translators.gemini.genai.GenerativeModel")
    @patch("rsstranslator.backend.models.translators.gemini.sleep")
